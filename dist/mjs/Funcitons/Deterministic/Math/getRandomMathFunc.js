 ...
 */
export const getRandomMathFunciton = () => {
 ...
 * @returns
 */
export const generateRandomMathArgs = () => {
    return Array(Math.floor(Math.random()
        * (GetRandomMathFuncConstants.MIN_ARGS - GetRandomMathFuncConstants.MIN_ARGS)) + GetRandomMathFuncConstants.MIN_ARGS).fill(null).map(() => {
